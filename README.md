...
독일어 원문은 전체 5,387개 레코드에 들어 있다. 《선악의 저편》·《도덕의 계보》·《안티크리스트》·《우상의 황혼》 전체와 《즐거운 학문》의 첫 900개, 합계 4,799개에는 프로젝트가 독일어 원문에서 직접 만든 한국어 번역 초안이 있다. 《즐거운 학문》의 나머지 588개는 직접 번역 전까지 `pending`으로 두며 자동 번역을 대신 공개하지 않는다. 한국어는 독일어 정본을 기준으로 별도 캐시에서 관리하고 현대 한국어 출판 번역을 복제하지 않는다.
