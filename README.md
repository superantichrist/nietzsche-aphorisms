...
| 합계 | 5,395 | 독일어 전 작품 범위 |

독일어 원문과 프로젝트가 원문에서 직접 만든 한국어 번역은 전체 5,395개 레코드에 모두 들어 있다. 다섯 작품 전량을 독일어와 대조해 통독 감수했으며, 고전어·인명·문헌 맥락과 시대적 비하 표현에는 필요한 각주를 붙였다. 한국어는 독일어 정본을 기준으로 별도 캐시에서 관리하므로 안정 ID와 독일어 출전을 바꾸지 않고 계속 교정할 수 있다. 현대 한국어 출판 번역은 복제하지 않았다.
