...
| Die fröhliche Wissenschaft | 1,490 | 서문, 전주곡, 제1–5권 §1–383, 부록 노래 |
| 합계 | 5,393 | 독일어 전 작품 범위 |

독일어 원문과 프로젝트가 원문에서 직접 만든 한국어 번역은 전체 5,393개 레코드에 모두 들어 있다. 한국어는 독일어 정본을 기준으로 별도 캐시에서 관리하므로 안정 ID와 독일어 출전을 바꾸지 않고 계속 교정할 수 있다. 현대 한국어 출판 번역은 복제하지 않았다. 현재 《안티크리스트》와 《우상의 황혼》은 전량 통독 감수를 마쳤고, 나머지 작품도 같은 절차로 순차 감수 중이다.
